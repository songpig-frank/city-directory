<?php
/**
 * Handler: Tourism & Tourist Spots Feed
 */
...
$categories = db_query(
    "SELECT c.*, COUNT(l.id) as listing_count
     ...
     WHERE c.is_active = 1 AND l.type = 'tourism'
     GROUP BY c.id
     ORDER BY c.sort_order, c.name"
);

$where = "l.status = 'active' AND l.type = 'tourism'";
...
echo render_page('directory', [
    'title'      => 'Tampakan Tourism & Spots — ' . config('site_name'),
